<template>
  ...
  <div class="matrixContainer">
    ...
    <div class="matrixPage">
      <!-- 页面头部 -->
      <div class="matrixPageHeader">
        <div class="pageTitle">
          <div class="left">
            <span class="matrix">Matrix</span>
            <span class="community">社区</span>
          </div>
          <div class="right">
            <i class="iconfont icon-Matrix"></i>
            <span class="author">成为作者</span>
          </div>
        </div>
        <div class="pageTabs">
          <ul class="items">
            <li class="item active">社区广场</li>
            <li class="item">专栏</li>
            <li class="item">一派</li>
          </ul>
        </div>
            ...
            <ul class="postsList">
              <li class="postsListItem">
                <a class="postItem" href="">
                  <div class="postInfo">
                    <div class="postTitle">优质的图书内容怎么找？</div>
                    <div class="postBottom">
                      <a class="postAuthor" href="">
                        <img
                          ...
                          alt=""
                        />
                        <span class="authorName">DrSelfie</span>
                      </a>
                      <div class="postOther">
                  ...
                  <img
                    class="postCover"
                    src="../../../public/images/itemcover.jpg"
                  />
                </a>
              </li>
              <li class="postsListItem">
          ...
          <div class="sideContainerr">
            ...
            <div class="yipai">
              ...
              <div class="yipaiCover">
                <img src="../../../public/images/yipaicover.jpg" alt="" />
                <span class="yipaiTag">
                  <i class="iconfont icon-shengbo"></i>
                  <span>讨论</span>
                </span>
              </div>
              <div class="yipaiInfo">假期里你遇到的最糟心/满足的事？</div>
              ...
              <ul class="recommendList">
                <li class="recommendListItem">
                  <a class="recommendItem" href="">
                    ...
                    />
                    <div class="info">
                      <span class="name">nerd_du</span>
                      <span class="intro"
                        >有事请通过邮件联系：johndu@sspai.com
                      </span>
                    </div>
                  </a>
                </li>
              ...
              <ul class="recommendList">
                <li class="recommendListItem">
                  <a class="recommendItem" href="">
                    ...
                    />
                    <div class="info">
                      <span class="name">数字生活方式</span>
                      <span class="intro">591 人关注 </span>
                    </div>
                  </a>
                </li>
                <li class="recommendListItem">
